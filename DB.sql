...
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Máy phát nhạc MP3 trên nền kit nhúng", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 0, null, 1, 2, 2, 2);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Hệ thống cảnh báo bằng phát hiện chuyển động trên kit nhúng Raspberry Pi", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 0, null, 1, 2, 2, 2);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Tìm hiểu Công nghệ PHP Laravel Framework và xây dựng Website kinh doanh thời trang nam, nữ kiểu mới", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 1, 9, 1, 2, 1, 1);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Tìm hiêu Công nghệ SpringBoot, Thymeleaf và xây dựng Website học trực tuyến", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 1, 9, 1, 2, 1, 1);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Tìm hiểu cơ chế chuyển đổi lưu trữ dữ liệu từ dạng quan hệ sang dạng NoSQL.", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2022, 0, null, 1, 5, 3, 3);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Tìm hiểu Công nghệ Spring boot, spring security, spring hibernate và xây dựng Website quản lý điều xe", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2022, 0, null, 1, 5, 1, 4);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Hệ thống giám sát cửa gara dùng kit nhúng Raspberry Pi", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2022, 0, null, 1, 5, 2, 6);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Hệ thống giám sát nhà dùng Raspberry Pi B+", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2022, 0, null, 1, 5, 2, 6);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Xây dựng ứng dụng Web với MEAN Stack.", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2022, 0, null, 1, 7, 3, 7);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Xây dựng ứng dụng IoT với NodeJS.", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2022, 0, null, 1, 7, 3, 7);
-- 10 Topic tiếp theo typeOfTopic la 2 
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES(" Hệ thống giám sát cửa Garage dùng Raspberry Pi", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 0, null, 1, 2, 2, 2);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Hệ thống cảnh báo phát hiện chuyển động dùng Raspberry Pi", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2022, 0, null, 1, 5, 2, 2);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Xây dựng hệ thống website đặt vé xe sử dụng Laravel và Angular 4", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 1, 9, 1, 1, 1, 4);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Tìm hiểu và ứng dụng Two - Factor Authentication và SignalR cho hệ thống web", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 1, 9, 1, 1, 1, 5);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Xây dựng hệ thống quản lý chuỗi cửa hàng tiện lợi với MEAN Stack", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 0, null, 2, 3, 3, 3);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Xây dựng Ứng dụng tìm việc làm trên di động bằng React Native", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 0, null, 2, 3, 1, 8);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Tìm hiểu Two - Factor Authentication và ứng dụng bảo mật website.", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2022, 0, null, 1, 4, 2, 6);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Kiểm soát các truy cập Web trong mạng nội bộ", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2022, 0, null, 1, 4, 2, 6);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Xây dựng hệ thống camera giám sát với Android Things.", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 0, null, 1, 1, 3, 7);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Khai phá luật kết hợp song song", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 0, null, 1, 1, 3, 7);
