...
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Máy phát nhạc MP3 trên nền kit nhúng", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 2, null, 1, 2, 2, 2);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Hệ thống cảnh báo bằng phát hiện chuyển động trên kit nhúng Raspberry Pi", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 2, null, 1, 2, 2, 2);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Tìm hiểu Công nghệ PHP Laravel Framework và xây dựng Website kinh doanh thời trang nam, nữ kiểu mới", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 2, 9, 1, 2, 1, 1);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Tìm hiêu Công nghệ SpringBoot, Thymeleaf và xây dựng Website học trực tuyến", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 4, 9, 1, 2, 1, 1);
...
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES(" Hệ thống giám sát cửa Garage dùng Raspberry Pi", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 2, null, 1, 2, 2, 2);
...
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Xây dựng hệ thống website đặt vé xe sử dụng Laravel và Angular 4", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 2, 9, 1, 1, 1, 4);
...
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Xây dựng hệ thống camera giám sát với Android Things.", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 2, null, 1, 1, 3, 7);
INSERT INTO Topic (topicName, topicRequire, topicGoal, schoolYear, quantity, point, typeID, periodID, subjectID, lecturerID) VALUES("Khai phá luật kết hợp song song", "Ít nhất 1 sinh viên tham gia", "Xây dựng xong chương trình", 2021, 2, null, 1, 1, 3, 7);
