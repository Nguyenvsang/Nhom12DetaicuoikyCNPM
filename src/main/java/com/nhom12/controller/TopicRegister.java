...
@WebServlet(name = "TopicRegister", urlPatterns = {"/topicregister"})
public class TopicRegister extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher(request.getContextPath() + "/register_topic.jsp");
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.addTopic(topicID, topicName, topicRequire, topicGoal, schoolYear, typeID, subjectID);
