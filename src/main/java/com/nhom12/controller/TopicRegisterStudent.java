        ...
        if (session != null && student != null) {
            ...
            if (tr != null) {
                ...
                if (team.getQuantity() == 2 || topic.getQuantity() == 2) {
                    ...
                    dao3.editTopic(topicID, topic.getTopicName(), topic.getTopicRequire(), topic.getTopicGoal(), topic.getSchoolYear(), topic.getTypeID(), topic.getSubjectID(), topic.getLecturerID(), topic.getQuantity() + 1);
