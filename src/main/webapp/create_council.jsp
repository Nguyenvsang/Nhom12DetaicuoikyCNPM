                    ...
                    <div class="card">
                        <form role="form" method="post"
                            ...
                            <div class="card-header">
                                <h3 class="card-title">Danh sách đề tài chưa được tạo hội đồng</h3>
                        ...
                        <label style="margin-left: 20px">Chọn đề tài muốn tạo hội đồng</label>
                        ...
                        <div class="card-body" >
                            <table class="table table-bordered table-hover" id="example2">
                                ...
                                <tbody>
                                    <c:forEach items="${listtopicnocouncil}" var="i" >
                                        <tr>
                                            <td>${i.topicID}</td>
                                            <td>${i.topicName}</td>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary btn-success ${i.quantity == 5 ? "disabled" : ""}"  style="font-size: 14px"
                                                        data-toggle="modal"
                                                        data-target="#staticBackdrop-${i.topicID}">Tạo</button>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <span class="text-warning"> Bạn có chắc muốn tạo hội đồng phản biện cho đề tài ${i.topicID} không?</span>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button"
                                                            class="btn btn-warning  btn-secondary"
                                                            data-dismiss="modal">Hủy</button>
                                                    <form action="${pageContext.request.contextPath}/createCouncil?topicID=${i.topicID}"
                                                          method="post">
